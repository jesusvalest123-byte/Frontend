...
function CrearProyecto({ usuario, onBack, onCreado }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMensaje("❌ Error al crear proyecto: " + (error.response?.data?.message || error.message));
    }
  };

  return (
    <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6">
      <h2 className="text-2xl font-bold text-cyan-600 mb-6 text-center">Crear Proyecto</h2>
